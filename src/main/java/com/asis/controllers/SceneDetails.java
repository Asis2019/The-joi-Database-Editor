...
public class SceneDetails implements AddableSceneImage {
    ...
    private void addLineTab(LineGroup lineGroup) {
        try {
            ...
            createNewTab(tabNormalOperationController, "/fxml/tab_normal_operation.fxml", 0);
    ...
    private void addTimerTab(Timer timer) {
        try {
            ...
            createNewTab(tabTimerController, "/fxml/tab_timer.fxml", 1);
    ...
    private void addDialogTab(Dialog dialog) {
        try {
            ...
            createNewTab(tabDialogOptionController, "/fxml/tab_dialog_option.fxml", 1);
    ...
    private void addTransitionTab(Transition transition) {
        try {
            ...
            createNewTab(tabTransitionController, "/fxml/tab_transition.fxml");
