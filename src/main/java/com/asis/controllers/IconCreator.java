...
public class IconCreator {
    ...
    public static Image show() {
        try {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(IconCreator.class.getResource("/fxml/icon_creator.fxml"));
    ...
    private void createAndDisplayIcon() throws IOException {
        ...
        // Draw border
        BufferedImage border = ImageIO.read(getClass().getResourceAsStream("/images/icon_template.png"));
