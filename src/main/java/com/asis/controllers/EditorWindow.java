...
public abstract class EditorWindow {
    ...
    protected void actionToggleGrid() {
        ...
        ImageView imageView;
        if (snapToGrid)
            imageView = new ImageView(new Image(getClass().getResourceAsStream("/images/ic_grid_on.png")));
        else
            imageView = new ImageView(new Image(getClass().getResourceAsStream("/images/ic_grid_off.png")));
    ...
    protected void actionToggleThumbnail() {
        ...
        ImageView imageView;
        if (showThumbnail)
            imageView = new ImageView(new Image(getClass().getResourceAsStream("/images/ic_thumbnail_on.png")));
        else
            imageView = new ImageView(new Image(getClass().getResourceAsStream("/images/ic_thumbnail_off.png")));
